  ...
  <tr>
    <td style="text-align: center"><a href="footwears.php">Footwears</a></td>
	 ...
	 <form method="post" action="ship.php">
   	  <table  width="1086" height="274" border ="0">
   <tr>
    <td width="164" height="50" style="text-align:right">
      <p>Email:</p>
       </td>
       <td width="906" height="50">
       <input type="email" name="email" maxlength="40" required></td>
    </tr>
    <tr height="20">
    <td  width="200" height="50"  style="text-align:right">
    <p>ShippingName:</p></td>
    <td>
      <input type="text"  name="shipname" maxlength="20" required> </td>
    </td>
    </tr>
     <tr height="20">
   ...
   <td>
     <textarea name="shipaddr" id="descrip" cols="45" rows="5"></textarea></td>
    ...
    <td>
     <input type="text"  maxlength="20" name="pin" required>
    </td>
    </tr>
      <tr height="20">
    <td width="200" height="50" style="text-align:right" >
    ...
    <td>
     <input type="text"  maxlength="20" name="phno" required>
    </td>
    </tr>
    <tr height="80">
    <td></td>
    	<td height="94" valign="top">
        <input type="submit" value="PlaceOrder" name="SIGNUP"></td>
        </tr>
